...
int main()
{
    ...
    while (true)
    {
        ...
        if (IsKeyDown(VK_LMENU))
        {
            ...
            {
                Point playerPos = client.get_player_position();
                Point target = client.get_crosshair_position();
                ...
                if (dist > MAX_DIST)
                {
                    ...
                    target.x = playerPos.x + dx * scale;
                    target.y = playerPos.y + dy * scale;
                    target.z = playerPos.z + dz * scale;
                }
                ...
                client.teleport_to(target);

                if (debugLogs)
                {
                    std::cout << "[KEY] Left Alt teleport (dist=" << (int)dist << ")\n";
                }
